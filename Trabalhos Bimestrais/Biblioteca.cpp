...
void ConsultarAutorLetra(void)
{
    ...
    TpAutores R;
    char letra;
    int encontrou = 0, i;  // Variável para verificar se encontrou pelo menos um autor
...
void ConsultarLivroPalavra(void)
{
    ...
    TpAutores autor;
    char palavra[50];
    int encontrou = 0, i;  // Variável de controle para indicar se encontrou algum livro
